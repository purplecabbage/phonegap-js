...
PG.geolocation = {
    ...
    getCurrentPosition: function(successCallback, errorCallback, options) {
        ...
        PG.exec(null, null, "Geolocation", "getCurrentLocation", [enableHighAccuracy, timeout, maximumAge]);
    },
    ...
    watchPosition: function(successCallback, errorCallback, options) {
        ...
        PG.exec(null, null, "Geolocation", "start", [id, enableHighAccuracy, timeout, maximumAge]);
        return id;
    },
     ...
     * @param {Number} stamp
     */
    success: function(id, lat, lng, alt, altacc, head, vel, stamp) {
    ...
    clearWatch: function(id) {
        PG.exec(null, null, "Geolocation", "stop", [id]);
 ...
 */
PG.geolocation.usingPG = false;
PG.geolocation.usePG = function() {
    if (PG.geolocation.usingPG) {
        return;
    }
